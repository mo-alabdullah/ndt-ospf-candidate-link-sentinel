...
including 109 safe candidates, with one unsafe deployment. On the untouched
33-sample holdout, it accepted all 19 safe candidates and rejected all 14
unsafe candidates. The holdout result is empirical; the one-sided score
covered only 20 of 33 realized RTTs and does not establish nominal conformal
